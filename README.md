...
**Nombre:** Ricardo Ballesteros Amavizca
**Matrícula:** A01255358
...
- Email: A01255358@tec.mx
- GitHub: [@Ricardo-B04](https://github.com/Ricardo-B04)
...
```bash
git clone https://github.com/TuUsuario/TC2004B-RicardoB04.git
cd TC2004B-RicardoB04
```
